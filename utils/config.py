...
VQA_MODELS = {
    ...
    "llava-1.5-7b": ("Llava", "/data/storage/moreno.dinca/OpenBias/utils/llava/weights/llava-v1.5-7b"),
    "llava-1.5-13b": (
        "Llava", 
        "/home/moreno.dinca/weights/llava-v1.5-13b",
        {
            "yes_logit": 4874,
            "Yes_logit": 3869,
            "No_logit": 1939,
...
LLM_CONFIG = {
    ...
    'LLMs': {
        'llama2-7B': {
            ...
            'weights_path': '/home/moreno.dinca/weights/llama/weights/llama-2-7b-chat',
            'tokenizer_path': '/home/moreno.dinca/weights/llama/weights/llama-2-7b-chat/tokenizer.model',
            'yes_logit': 4874,
            'Yes_logit': 3869,
            'No_logit': 1939,
            'no_logit': 694
        ...
        'llama2-13B': {
            ...
            'weights_path': '/home/moreno.dinca/weights/llama/weights/llama-2-13b-chat',
            'tokenizer_path': '/home/moreno.dinca/weights/llama/weights/llama-2-7b-chat/tokenizer.model',
            'yes_logit': 4874,
            'Yes_logit': 3869,
            'No_logit': 1939,
        ...
        'llama3-8B': {
            ...
            'N_CUDA': 1,
            'model_parallel_size': 1,
            'weights_path': '/home/moreno.dinca/weights/llama/weights/Meta-Llama-3-8B-Instruct',
            'tokenizer_path': '/home/moreno.dinca/weights/llama/weights/Meta-Llama-3-8B-Instruct/tokenizer.model',
            'yes_logit': 9891,
            'Yes_logit': 9642,
            'No_logit': 2822,
            'no_logit': 2201
        ...
        'llama3-70B': {
            ...
            'weights_path': '/home/moreno.dinca/weights/llama/weights/Meta-Llama-3-70B-Instruct',
            'tokenizer_path': '/home/moreno.dinca/weights/llama/weights/Meta-Llama-3-70B-Instruct/tokenizer.model',
            'yes_logit': 9891,
            'Yes_logit': 9642,
            'No_logit': 2822,
            'no_logit': 2201
